...
function Footer(_ref, _ref2) {
	...
	return _react2.default.createElement(
		'div',
		_extends({ className: ((0, _noImportant.css)(classes.footer), 'footer') }, props),
		caption ? _react2.default.createElement('figcaption', { className: ((0, _noImportant.css)(classes.footerCaption), 'footer__caption'), dangerouslySetInnerHTML: { __html: caption } }) : _react2.default.createElement('span', null),
		imageCount
	);
}
