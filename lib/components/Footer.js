...
function Footer(_ref, _ref2) {
	...
	return _react2.default.createElement(
		...
		caption ? _react2.default.createElement('figcaption', { className: (0, _noImportant.css)(classes.footerCaption) + ' footerCaption', dangerouslySetInnerHTML: { __html: caption } }) : _react2.default.createElement('span', null),
		imageCount
	);
}
